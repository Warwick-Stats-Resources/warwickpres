...
This is a Quarto presentation format that is consistent with The University of Warwick's [branding](https://warwick.ac.uk/about/brand/) (especially [colours](https://warwick.ac.uk/about/brand/brand-guidelines/colours/) and [font](https://warwick.ac.uk/about/brand/brand-guidelines/typography/)).
...
<style type="text/css">
div.callout-note {
  border-left-color: #41748D !important;
}
...
div.callout-caution.callout-style-default .callout-title {
  background-color: #E2BDC2 !important;
}

div.callout-tip {
  border-left-color: #507F70 !important;
}

div.callout-tip.callout-style-default .callout-title {
  background-color: #CAD9D4 !important;
}

div.callout-important {
  border-left-color: #D69A2D !important;
}

div.callout-important.callout-style-default .callout-title {
  background-color: #F4E1C0 !important;
}

div.callout-warning {
  border-left-color: #BE531C !important;
}

div.callout-warning.callout-style-default .callout-title {
  background-color: #ECCABA !important;
}
</style>
```
