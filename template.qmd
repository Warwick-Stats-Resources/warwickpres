...
- render your presentation at least once
- an "offline_fonts.R" script will then appear in the root of your directory
- in the R console, run `source("offline_fonts.R")''
- render the presentation again
- a "fonts" directory will then appear in your root directory, and you can use the fonts offline.
