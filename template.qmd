...
# in `_extension/warwickpres/_extension.yml`
---
...
# Set `eval: true` and render once to set up offline fonts
# Then set back to false (or delete chunk)
...
- call `source("offline_fonts.R")` once in the R console, or
